...
public class CustomTextView extends TextView {
    ...
    private void setAttributeSet(Context context, AttributeSet attrs) {
        ...
        float radius = a.getDimension(R.styleable.customTextView_textRadius, 0);
        float leftTopRadius = a.getDimension(R.styleable.customTextView_textLeftTopRadius, 0);
        float leftBottomRadius = a.getDimension(R.styleable.customTextView_textLeftBottomRadius, 0);
        float rightTopRadius = a.getDimension(R.styleable.customTextView_textRightTopRadius, 0);
        float rightBottomRadius = a.getDimension(R.styleable.customTextView_textRightBottomRadius, 0);
